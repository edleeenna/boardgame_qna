...
#2. Define the data source and load data with PDFLoader(boardgame_qna\Arcs rulebook\Arcs_Base_Rulebook.pdf)
data_load=PyPDFLoader('boardgame_qna\Arcs rulebook\Arcs_Base_Rulebook.pdf')
# The below tests the above
